...
@endif
            ...
            <div class="">
                <div class="row" style="margin-bottom: 30px" >
                    <div  class="col-md-6"><a href='{{url("doctor/create")}}' class = "btn btn-success">Add</a></div>
                    <div  class="col-md-6"><a href='{{url("doctor/visit/log")}}' class = "btn btn-primary">Visited Log</a></div>
                </div>
