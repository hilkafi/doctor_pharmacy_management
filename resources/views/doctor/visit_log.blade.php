...
@endif
                ...
                <tr>
                <td>{{$i}}</td>
                <td>{{$data->doctor_name($data->doctor_id)}}</td>
                <td>{{$data->doctor_designation($data->doctor_id)}}</td>
                <td>{{$data->doctor_expertise($data->doctor_id)}}</td>
                <td>{{ $data->sumVisitByMpo($data->doctor_id) }}</td>
                <td><table><tr>
                
               <td>
                    <td><a href="{{url('doctor/visit')}}/{{$data->id}}/details"><button class="btn btn-success">V</button></a></td>
                </tr></table></td>
                </tr>
                @endforeach
