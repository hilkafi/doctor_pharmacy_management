...
@endif
            ...
            <div class="">
                <div  class=""></div><a href='{{url("clinic/create")}}' class = "btn btn-success">Add</a><br><br>
                ...
                <td><table><tr><td> <a href='clinic/{{$data->_key}}/edit' class="btn btn-warning">E</a><br><br></td>
                
               <td> <form action="{{ route('clinic.destroy', $data->id) }}" method="POST">
                    @method('DELETE')
                     @csrf
                    <button class="btn btn-danger">D</button>
                    </form></td>
                     <td><a href="clinic/{{$data->_key}}/visit"><button class="btn btn-success">V</button></a></td> 
