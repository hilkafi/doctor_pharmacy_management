               ...
               <td> <form action="{{ route('area.destroy', $data->id) }}" method="POST">
                    ...
                    <button class="btn btn-danger">D</button>
                     ...
                     <td> <a href='district/{{$data->_key}}/details' class="btn btn-warning">V</a><br><br></td>
                     <td> <a href='district/{{$data->_key}}/view_pharmacy' class="btn btn-warning">VPh</a><br><br></td>   
                </tr></table></td>
