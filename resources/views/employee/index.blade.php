...
@endif
            ...
            <div class="">
                <div  class=""></div><a href='{{url("employee/create")}}' class = "btn btn-success">Add</a><br><br>
                ...
                <td><table><tr><td> <a href='employee/{{$data->_key}}/edit' class="btn btn-warning">E</a><br><br></td>
